const text = {
  home() {
    return `EATING, ELEVATED Discover an elevated dining experience in downtown Portland – a Pan Asian 
  ...
  about() {
    return `Those are questions that your restaurant’s mission statement should answer.
...
export {
  clickHome, clickAbout, clickContact, clickMenu,
};